...
class SABR:
    ...
    @staticmethod
    def fit(objective, initial_guess: Tuple[float, float, float, float], fwds: np.array, expiries: np.array, strike_matrix: np.array, vola_matrix: np.array, eps=0.0001) -> np.array:
